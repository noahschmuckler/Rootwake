...
export default defineConfig({
  ...
  build: {
    rollupOptions: {
      ...
      input: { index: 'index.html', under: 'under.html', lab: 'lab.html', rootDiscovery: 'root-discovery.html', ravine: 'ravine.html', watershed: 'watershed.html', karst: 'karst.html', flow: 'flow.html', karstFlow: 'karst-flow.html', village: 'village.html', planet: 'planet.html' },
    },
  },
});
