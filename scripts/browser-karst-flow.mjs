...
try{
 ...
 await press(page,195,420);await page.waitForTimeout(120);await press(page,195,420);await waitMode(page,'sink',5000);await waitMode(page,'mouth',10000);assert.equal(await at(page),'cavernFern');
