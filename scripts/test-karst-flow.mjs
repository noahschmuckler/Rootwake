...
const output = '.karst-flow-tests.mjs';
try {
  await build({ entryPoints: ['tests/karstFlow.test.ts'], bundle: true, platform: 'node', format: 'esm', outfile: output, packages: 'external' });
