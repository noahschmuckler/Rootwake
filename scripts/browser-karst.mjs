...
const report=[];
async function settle(page){await page.waitForFunction(()=>window.__karst&&!window.__karst.transitioning,null,{timeout:120000});await page.waitForTimeout(750);}
