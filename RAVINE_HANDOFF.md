...
## Current checkpoint
Scope recorded. Implementation not yet written at this checkpoint. Next: implement model/world/UI, then verify. Append real commands, results, source commits and any blockers here before ending.
